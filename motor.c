...
{
	//front_left_speed_duty=SPEED_DUTY;
	front_right_speed_duty=SPEED_DUTY/2; // 左电机
	behind_left_speed_duty=SPEED_DUTY/2; //右电机
	//behind_right_speed_duty=SPEED_DUTY;
}
...
void CarRight(void)
{
	...
	front_right_speed_duty=SPEED_DUTY;
	behind_left_speed_duty=-SPEED_DUTY;
	//behind_right_speed_duty=SPEED_DUTY;//增加后轮驱动力
}
...
void CarLeft(void)
{
	//front_left_speed_duty=SPEED_DUTY;
	front_right_speed_duty=-SPEED_DUTY;
	behind_left_speed_duty=SPEED_DUTY;//增加后轮驱动力
	//behind_right_speed_duty=-SPEED_DUTY;
}
void CarLeft1(void)
{
...
void CarLeft2(void)
{
	//front_left_speed_duty=SPEED_DUTY;
	front_right_speed_duty=-SPEED_DUTY/2;
	behind_left_speed_duty=SPEED_DUTY/2;//增加后轮驱动力
	//behind_right_speed_duty=-SPEED_DUTY;
}
